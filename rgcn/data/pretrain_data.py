...
if __name__ == "__main__":
    ...
    if args.dataset == "conceptnet":
        ...
        if os.path.exists("conceptnet_graph"):
            print("----------load existing graph----------")
            G = pickle.load(open("conceptnet_graph","rb"))
        else:
            print("----------construct graph----------")
            G = overall_graph(entity2id, triple_list)
            pickle.dump(G,open('conceptnet_graph','wb'))
        ...
        print("----------save dataset----------")
        pickle.dump(train_data,open('train_data_rgcn_conceptnet','wb'))
        pickle.dump(test_data,open('test_data_rgcn_conceptnet','wb'))
        print("----------done----------")
    else:
        # load ATOMIC tuples
        ...
        if os.path.exists("atomic_graph"):
            print("----------load existing graph----------")
            G = pickle.load(open("atomic_graph","rb"))
        else:
            print("----------construct graph----------")
            G = overall_graph(entity2id, triple_list)
            pickle.dump(G,open('atomic_graph','wb'))
        ...
        print("----------save dataset----------")
        pickle.dump(train_data,open('train_data_rgcn_atomic','wb'))
        pickle.dump(test_data,open('test_data_rgcn_atomic','wb'))
        print("----------done----------")
