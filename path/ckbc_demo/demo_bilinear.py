...
def run(gens_file, theshold=None, flip_r_e1=True):
    model = pickle.load(open("ckbc_demo/Bilinear_cetrainSize300frac1.0dSize200relSize150acti0.001.1e-05.800.RAND.tanh.txt19.pickle",  "rb"), encoding = 'iso-8859-1')
    # model = torch.load("ckbc_demo/Bilinear_cetrainSize300frac1.0dSize200relSize150acti0.001.1e-05.800.RAND.tanh.txt19.pickle")
